...
export default function SwapComponent() {
  ...
  const swappableTokens: Token[] = [ETHToken, USDCToken, WINTToken];

  return (
    <div className="flex flex-col w-1/3  border rounded-md shadow  border-gray-200/70 min-w-[320px] p-8 !max-w-[640px] mx-auto">
      {address ? (
        <Swap>
          <SwapAmountInput
            label="Sell"
